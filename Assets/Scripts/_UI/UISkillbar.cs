    ...
    void Update()
    {
        ...
        if (player != null)
        {
            ...
            for (int i = 0; i < player.skillbar.slots.Length; ++i)
            {
                ...
                if (skillIndex != -1 && player.skills.skills[skillIndex].canBeHotbarred)
                {
                    ...
                    slot.cooldownCircle.gameObject.SetActive(cooldown > 0);
                ...
                else if (inventoryIndex != -1)
                {
                    ...
                    if (itemSlot.item.data is UsableItem usable)
                    {
                        ...
                        slot.cooldownCircle.gameObject.SetActive(usable.cooldown > 0);
                    }
