...
public abstract class Equipment : ItemContainer, IHealthBonus, IChakraBonus, ICombatBonus
{
    // boni ////////////////////////////////////////////////////////////////////
    ...
    public WeaponItem.weaponType GetEquippedWeaponType()
    {
        // find the weapon slot
        int index = GetEquippedWeaponIndex();
        return index != -1 ? ((WeaponItem)slots[index].item.data).type : WeaponItem.weaponType.None;
    }
}
