...
public partial struct Skill
{
    ...
    public float selfStunTime => data.selfStunTime.Get(level);
    public float cooldown => data.cooldown.Get(level);
    public float castRange => data.castRange.Get(level);
    public int chakraCost => data.chakraCosts.Get(level);
    public int flickerCost => data.flickerPointCosts.Get(level);
    ...
    public bool canBeHotbarred => data.canBeHotbarred;
    ...
    public int animationCount => data.animationCount;
    public ScriptableSkill followUpSkill => data.followUpSkill;
    public bool isFollowup => data.isFollowup;
    public bool ignoreCastAnimation => data.ignoreCastAnimation;
