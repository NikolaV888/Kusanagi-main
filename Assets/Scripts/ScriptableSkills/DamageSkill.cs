...
public abstract class DamageSkill : ScriptableSkill
{
    ...
    public LinearFloat pushback; // How far it pushes the enemy
    public LinearFloat pushforward; // How far it pushes the player
    ...
    public override string ToolTip(int skillLevel, bool showRequirements = false)
    {
        ...
        tip.Replace("{PUSHBACK}", pushback.Get(skillLevel).ToString("F1"));
        return tip.ToString();
    }
}
